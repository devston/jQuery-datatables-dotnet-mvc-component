/*
 *  SB - This is a copy of the moment type. We have to place this one here due to the way moment has done their definition file.
 *  Once we can use a module loader, this can be safely removed and the one shipped with moment used instead.
 */
